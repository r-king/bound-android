...
/**
 * A fragment representing books marked on wishlist screen
 */
class WishlistFragment : Fragment(), Injectable {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        wishlistViewModel = ViewModelProviders.of(this, viewModelFactory)
        ...
        val rvAdapter = CompactBookListAdapter(
            ...
            navController().navigate(
                    WishlistFragmentDirections.showBook(book.id)
            )
        }
    ...
    private fun initRecyclerView() {
        ...
        wishlistViewModel.getWishlistBooks().observe(this, Observer { result ->
